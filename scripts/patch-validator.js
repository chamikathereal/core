...
const replacement = 'm=(i.includes("@fivora/editable-components")||i.includes("@deneb/ui"))&&(i.includes("SiteDataProvider")||i.includes("BaseSiteDataProvider")||i.includes("DenebDataProvider"))';

if (content.includes(target)) {
  content = content.replace(target, replacement);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log('Successfully patched validator to recognize @deneb/ui and DenebDataProvider!');
